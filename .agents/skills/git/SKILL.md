...
node .agents/skills/git/scripts/bump-version.js

# Bump patch version: 1.2.3 → 1.2.4
node .agents/skills/git/scripts/bump-version.js patch

# Bump major version: 1.2.3 → 2.0.0
node .agents/skills/git/scripts/bump-version.js major
```
