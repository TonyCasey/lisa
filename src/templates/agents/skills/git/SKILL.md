---
name: git
description: "GitHub and Git workflow helpers; triggers on 'create pr', 'pr checks', 'retrigger tests'."
---

## Purpose
Model-neutral helper for GitHub and Git workflows including PR management, CI triggers, and branch operations.

## Triggers
Use when the user says: "create a pr", "check pr status", "retrigger tests", "toggle test label", "pr checks".
...
.agents/skills/git/scripts/poll-ci.sh

# Poll specific branch
.agents/skills/git/scripts/poll-ci.sh feature-branch
```
