export {}; // keep declarations scoped to this module
...
function extractEventStreamData(text: string) {
...
async function initialize(timeoutMs: number = 8000) {
  const body = {
    jsonrpc: '2.0',
    id: 'init',
    method: 'initialize',
...
function withGroup(params: Record<string, unknown>, groupId: string | null = null) {
